...
print("
 <h1>Students of $parent1 $parent2</h1>
 <br>
...
print("
 ...
 while($info = mysql_fetch_row($query))
 {
  ...
  $temp0 = htmlspecialchars($temp[0]);
  $temp1 = htmlspecialchars($temp[1]);

  print("<tr class='".( $row%2==0 ? "even" : "odd" )."'>
  <td><a class='items' href=\"javascript:document.classes.student.value=$temp[2];document.classes.page2.value=5;document.classes.submit();\">$temp0 $temp1</a></td>
  </tr>");
 }
print("  </table>
  <br />
